...
We will use three prediction model techniques and will plot the confusion matrix at the end of each to decide which method best fit. These methods will be - Random Forests, Decision Tress and Generalized  Boosted Model.
...
## Conclusion
We found that accuracy of the different models are -   
a. Random Forest - 
b. Decision Trees - 
c. Generalized Boosted Model - 

So we are going to use Random Forest as the accuracy is the maximum.
